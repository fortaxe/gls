...
// // Import jQuery + OwlCarousel (browser-only)
// import "jquery";
...
//       {/* First carousel */}
//       <div id="arawali-city" className="owl-carousel">
...
//         <div className="item">About 1</div>
//         <div className="item">About 2</div>
//         <div className="item">About 3</div>
//       </div>
//     </Wrapper>
//   );
// };
